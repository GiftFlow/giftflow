...
$config['email_templates'] = array(
	'transaction_new' => array('en' => '<p><b>Hello {{decider_name}},</b></p><p>{{summary}}</p><p>{{demander_name}} wrote:<br/>"{{note}}"</p><p><a href="{{return_url}}">Click Here to Login and Respond</a></p>'),
