...
$config['email_templates'] = array(
	...
	'transaction_completed' => array('en' => '<p><b>Hello {{receiver_name}},</b></p><p>{{summary}} </p><p><b>{{completer_name}}</b> has marked your gift interaction as complete! </p><p><a href="{{return_url}}">Click Here to Login and write a review</a></p>'),
	...
	'thank_invite' => array('en' => '<p><b>Hello {{recipient_email}},</b></p><p>{{thanker_screen_name}} has thanked you on <a href="'.site_url().'">GiftFlow</a> for: "{{gift_title}}".</p><p>{{thanker_screen_name}} wrote: </p><p>"{{body}}"</p><div><p>GiftFlow is an online community of giving where users post what they need and what they can give away. <a href="'.site_url("member/register").'">Register</a> and be recognized for your generosity.</p><p>This Thank will not be published online unless you create an account with this email address. </p></div>')
