...
class CI_DB_active_record extends CI_DB_driver {
	...
	/**
	* Adds parentheses to WHERE AND OR situations to ensure proper chaining
	* Taken from http://blog.atomni.com/code-igniter-active-record-and-chaining-where-and-or_where/
	*
	*/
